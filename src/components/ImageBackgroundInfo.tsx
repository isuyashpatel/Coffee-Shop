        ...
        {EnablebackHandler ? (
          <View style={styles.ImageHeaderBarContainerWithBack}>
            <TouchableOpacity onPress={() => { BackHandler(); }}>
              <GradientBGIcon name='chevron-back' color={COLORS.primaryLightGreyHex} size={FONTSIZE.size_30} />
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => { ToggleFavourite(favourite, type, id); }}>
              <GradientBGIcon name='heart' color={COLORS.primaryLightGreyHex} size={FONTSIZE.size_30} />
            </TouchableOpacity>
          </View>)}
          ...
          <View style={styles.ImageInfoInnerContainer}>
            <View style={styles.InfoContainerRow}>
              ...
              <View style={styles.ItemPropertiesContainer}>
                 ...
                 <View style={styles.ProperFirst}>
                    <MaterialCommunityIcons
                     name={type== 'Bean' ? 'navigation-variant':'water'}
            ...
            <View style={styles.InfoContainerRow}>
              <View style={styles.RatingContainer}>
                <MaterialCommunityIcons name='star' color={COLORS.primaryOrangeHex} size={FONTSIZE.size_20}/>
